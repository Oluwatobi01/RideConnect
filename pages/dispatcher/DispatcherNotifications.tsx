...
const DispatcherNotifications: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen w-full bg-background-light dark:bg-background-dark text-text-primary-light dark:text-text-primary-dark font-display">
      ...
      <div className="p-4 space-y-4">
        <div className="flex items-center justify-between p-4 bg-card-light dark:bg-card-dark rounded-xl">
            <span className="font-medium">New Orders</span>
            <div className="w-10 h-6 bg-success rounded-full relative"><div className="absolute right-1 top-1 bg-white size-4 rounded-full"></div></div>
        </div>
        <div className="flex items-center justify-between p-4 bg-card-light dark:bg-card-dark rounded-xl">
            <span className="font-medium">Driver Alerts</span>
            <div className="w-10 h-6 bg-success rounded-full relative"><div className="absolute right-1 top-1 bg-white size-4 rounded-full"></div></div>
        </div>
      </div>
    </div>
